...
if (isset($_GET['id'])) {
  ...
  $query = "SELECT * FROM siswa,kelas where siswa.nisn='$id' AND siswa.id_kelas=kelas.id_kelas";
                    ...
                    <form class="wizard-content mt-2" method="post" action="proses_editsiswa.php">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label class="text-md-right"><b>NISN</b></label>
                          <input name="nisn" class="form-control" value="<?php echo $data['nisn']; ?>" disabled="" />
                        </div>
                        <div class="form-group col-md-6">
                          <label class="text-md-right"><b>NIS</b></label>
                          <input type="text" class="form-control" name="nis" value="<?php echo $data['nis']; ?>" disabled="disabled" />
                        </div>
                      </div>
